...
const ALL_QUESTIONS = [
  { std: '3.OA.4', text: '? × 6 = 48', ans: '8', choices: ['6', '7', '8', '9'] },
  { std: '3.OA.4', text: '? × 7 = 35', ans: '5', choices: ['4', '5', '6', '7'] },
  { std: '3.OA.4', text: '9 × ? = 63', ans: '7', choices: ['6', '7', '8', '9'] },
  { std: '3.OA.4', text: '? × 8 = 56', ans: '7', choices: ['5', '6', '7', '8'] },
  { std: '3.OA.4', text: '? × 4 = 36', ans: '9', choices: ['7', '8', '9', '10'] },
  { std: '3.OA.4', text: '6 × ? = 42', ans: '7', choices: ['5', '6', '7', '8'] },
  { std: '3.OA.6', text: 'If 7 × 8 = 56, then 56 ÷ 8 = ?', ans: '7', choices: ['6', '7', '8', '9'] },
  { std: '3.OA.6', text: 'If 6 × 9 = 54, then 54 ÷ 9 = ?', ans: '6', choices: ['5', '6', '7', '8'] },
  { std: '3.OA.6', text: 'If 4 × 7 = 28, then 28 ÷ 4 = ?', ans: '7', choices: ['5', '6', '7', '8'] },
  { std: '3.OA.6', text: 'If 5 × 8 = 40, then 40 ÷ 5 = ?', ans: '8', choices: ['6', '7', '8', '9'] },
  ...
  return (
    <>
      <style>{`
        ...
        .qf-q-text { font-size:22px; font-weight:900; line-height:1.35; color:#1e1e6e; }
      ...
      <div className="qf-shell">
        ...
        {phase === 'start' && (
          <div className="qf-card">
            ...
            <div className="qf-card-title">Quick Fire!</div>
            <div className="qf-card-sub">
              Answer as many questions as you can in <strong>60 seconds</strong>. Pick the right answer fast!
            </div>
        ...
        {phase === 'playing' && currentQ && (
          <>
            <div className="qf-header">
              <div className="qf-title">⚡ Quick Fire!</div>
